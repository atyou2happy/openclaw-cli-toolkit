...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/工具-140+-brightgreen.svg" alt="工具: 140+"/>
  <img src="https://img.shields.io/badge/类别-26-blue.svg" alt="26 个类别"/>
...
- **26 个类别** — 搜索、查看、数据、系统、网络、Git、终端、开发、安全、压缩、文档、下载、AI、LaTeX、格式处理、容器、数据库、媒体、图表、API 测试、文本处理、Kubernetes、Go 开发、可观测性、Git 助手、测试
...
| 📄 格式处理 | qpdf, weasyprint, visidata, xsv, gron, yamllint, taplo, htmlq, tidy, xmllint, xmlstarlet, lychee | 手动格式处理 |
| 🐳 容器 | docker, docker-compose | 手动环境配置 |
| 🗄️ 数据库 | sqlite3, usql | GUI 数据库工具 |
| 🎨 媒体 | imagemagick, exiftool, ffmpeg | GUI 媒体编辑器 |
| 📐 图表 | d2, graphviz | 手动图表绘制 |
| 🧪 API 测试 | wrk, hey, oha, hurl, grpcurl | ab, siege, 手动 API 测试 |
| ✂️ 文本处理 | sd, gum, choose, grep-ast, tabulate | sed, cut, 手动文本转换 |
| ☸️ Kubernetes | kubectl, helm, k9s, stern | kubectl, helm |
| 🦬 Go 开发 | golangci-lint, goimports, staticcheck | go vet |
| 📊 可观测性 | stern, ctop, glances | top, htop |
| 🔀 Git 助手 | git-lfs, ghq, myrepos | git submodule |
| 🧪 测试 | bats, coverage, junit2html | 手动测试 |
