...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/工具-62+-brightgreen.svg" alt="工具: 62+"/>
...
- **15 个类别** — 搜索、查看、数据、系统、网络、Git、终端、开发、安全、压缩、文档、下载、AI、LaTeX、格式处理
...
| 📄 格式处理 | qpdf, visidata, xsv, gron, lychee | 手动格式处理 |
