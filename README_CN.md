...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/工具-87+-brightgreen.svg" alt="工具: 87+"/>
  <img src="https://img.shields.io/badge/类别-19-blue.svg" alt="19 个类别"/>
...
- **19 个类别** — 搜索、查看、数据、系统、网络、Git、终端、开发、安全、压缩、文档、下载、AI、LaTeX、格式处理、容器、数据库、媒体、图表
